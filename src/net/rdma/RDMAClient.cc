...
bool RDMAClient::remoteAllocSegments(const string& connection, const string& bufferName, const size_t segmentsCount, 
                                     const size_t segmentsSize, size_t& offset, BufferHandle::Buffertype buffertype)
{
  ...
  Any sendAny = MessageTypes::createDPIAllocSegmentsRequest(bufferName, segmentsCount, segmentsSize, buffertype);
  Any rcvAny;
