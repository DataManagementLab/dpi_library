...
//   BufferSegment segment = buffHandle->entrySegments[0];
...
//   std::cout << "handle_ret->segments.size()" << handle_ret->entrySegments.size() << '\n';
...
//   BufferSegment segment1 = buffHandle->entrySegments[0];
//   CPPUNIT_ASSERT_EQUAL(1024, ((int)segment1.size));
//   CPPUNIT_ASSERT_EQUAL(800, ((int)segment1.threshold));

//   BufferSegment segment2 = buffHandle->entrySegments[1];
